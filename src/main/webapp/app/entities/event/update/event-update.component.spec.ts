...
describe('Event Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const author: IUser = { id: 53058 };
      event.author = author;
      const participants: IUser[] = [{ id: 23522 }];
      event.participants = participants;

      const userCollection: IUser[] = [{ id: 79014 }];
      jest.spyOn(userService, 'query').mockReturnValue(of(new HttpResponse({ body: userCollection })));
      const additionalUsers = [author, ...participants];
    ...
    it('Should update editForm', () => {
      const event: IEvent = { id: 456 };
      const author: IUser = { id: 79249 };
      event.author = author;
      const participants: IUser = { id: 43969 };
      event.participants = [participants];

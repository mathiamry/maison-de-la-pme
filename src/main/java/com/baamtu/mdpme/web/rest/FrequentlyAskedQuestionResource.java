...
public class FrequentlyAskedQuestionResource {
    ...
    public ResponseEntity<List<FrequentlyAskedQuestion>> getAllFrequentlyAskedQuestions(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get a page of FrequentlyAskedQuestions");
        Page<FrequentlyAskedQuestion> page = frequentlyAskedQuestionRepository.findAll(pageable);
